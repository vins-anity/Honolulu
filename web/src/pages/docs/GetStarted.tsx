			...
			<section className="space-y-6">
				...
				<div className="space-y-4">
					<div className="flex gap-4 items-start">
						<span className="flex-shrink-0 w-8 h-8 bg-rose-500/20 text-rose-400 rounded-full flex items-center justify-center font-bold text-sm">
							1
						</span>
						<div className="flex-1">
							<h3 className="font-medium text-white mb-2">Create a new project</h3>
							<CodeBlock code="bun create honolulu@latest my-app" language="bash" />
						</div>
					</div>
					...
					<div className="flex gap-4 items-start">
						...
						<ul className="text-slate-400 text-sm list-disc list-inside space-y-1">
							<li>
								<strong>Architecture:</strong> Opinionated (Monorepo) or Unopinionated (Single
								Package)
							</li>
							<li>
								<strong>Styling:</strong> Tailwind CSS v4, Shadcn UI, or Classic CSS
							</li>
							<li>
								<strong>Database:</strong> Postgres (via Drizzle) or SQLite
							</li>
							<li>
								<strong>Authentication:</strong> Better Auth, Clerk, or Supabase
							</li>
						</ul>
					</div>
...
bun run dev`}
				...
				<div className="bg-teal-500/10 border border-teal-500/20 rounded-xl p-4">
					<p className="text-teal-300 text-sm">
						<strong>That's it!</strong> Your API runs at{" "}
						<code className="bg-black/30 px-1 rounded">localhost:3000</code> and frontend at{" "}
						<code className="bg-black/30 px-1 rounded">localhost:5173</code>.
					</p>
				</div>
			</section>
						...
						<div className="grid md:grid-cols-2 gap-6">
							<div className="space-y-4">
								<div className="flex gap-3">
									<span className="flex-shrink-0 w-6 h-6 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center font-bold text-xs">
										1
									</span>
									<div>
										<p className="text-white font-medium mb-1">Connect Source</p>
										<p className="text-slate-400 text-sm">
											Update <code className="text-rose-400">.env</code> with your{" "}
											<code className="text-blue-300">DATABASE_URL</code>.
										</p>
									</div>
								</div>
								<div className="flex gap-3">
									<span className="flex-shrink-0 w-6 h-6 bg-purple-500/20 text-purple-400 rounded-full flex items-center justify-center font-bold text-xs">
										2
									</span>
									<div>
			...
			<section className="space-y-4">
				...
				<div className="flex flex-wrap gap-3">
					<Link
						to="/docs/why-honolulu"
						className="px-4 py-2 bg-indigo-500/20 border border-indigo-500/30 rounded-lg text-indigo-300 hover:bg-indigo-500/30 transition-colors"
					>
						Why Honolulu? →
					</Link>
					<Link
