import { Zap, Layers, Shield, Rocket, Clock, Sparkles, ExternalLink, Heart } from "lucide-react";
        ...
        <div className="space-y-12">
            <div>
                ...
                <p className="text-lg text-slate-400 leading-relaxed max-w-2xl">
                    <strong className="text-white">Ship faster. Stay sane.</strong> Honolulu is a production-ready monorepo starter
                    that combines the fastest tools in the JavaScript ecosystem.
                </p>
            </div>
            ...
            <section className="space-y-4">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                    <p className="text-slate-400 leading-relaxed">
                        Starting a new full-stack project is exhausting. You spend days configuring bundlers, setting up TypeScript,
                        wiring up databases, and fighting with ESLint configs. By the time you can write business logic,
                        you've already burned out.
                    </p>
                    <p className="text-slate-400 leading-relaxed mt-4">
                        <strong className="text-white">Type safety?</strong> Good luck keeping your frontend and backend in sync manually.
                        One API change, and your frontend breaks silently.
                    </p>
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <p className="text-slate-400">
                    Honolulu gives you a <strong className="text-white">pre-configured, modern stack</strong> with end-to-end type safety out of the box:
                </p>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div className="bg-gradient-to-br from-rose-500/10 to-transparent border border-rose-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            Bun as runtime, Vite for bundling, Hono for routing. 10x faster than Node + Express + Webpack.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            Shared Valibot schemas between frontend and backend. Catch API mismatches at compile time, not in production.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            Turborepo for caching and orchestration. Workspaces for clean dependencies. One command to run everything.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-teal-500/10 to-transparent border border-teal-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            Hono runs on Cloudflare Workers, AWS Lambda, Vercel, Railway, Fly.io, or your own VPS. No vendor lock-in.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-orange-500/10 to-transparent border border-orange-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            No webpack.config.js, no babel, no ESLint rules. Just Biome for linting, Vite for bundling, TypeScript for safety.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-pink-500/10 to-transparent border border-pink-500/20 rounded-xl p-5">
                        ...
                        <p className="text-slate-400 text-sm">
                            Hot reload everywhere. Drizzle Studio for database. React 19 features. Tailwind CSS v4.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-800/50">
                            <tr>
                                ...
                                <td className="py-3 px-4"><span className="text-rose-400">Bun</span></td>
                                <td className="py-3 px-4 text-slate-400">Life's too short for slow installs. Bun makes Node feel like dial-up.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Backend</td>
                                <td className="py-3 px-4"><span className="text-teal-400">Hono</span></td>
                                <td className="py-3 px-4 text-slate-400">Express, but if it hit the gym and learned to run on the edge.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Frontend</td>
                                <td className="py-3 px-4"><span className="text-blue-400">React 19 + Vite + SWC (Rust)</span></td>
                                <td className="py-3 px-4 text-slate-400">Webpack traumatized us. Vite healed us. React 19 made us believers again.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Database</td>
                                <td className="py-3 px-4"><span className="text-green-400">Drizzle ORM</span></td>
                                <td className="py-3 px-4 text-slate-400">SQL is beautiful. ORMs that hide it aren't. Drizzle gets it.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Validation</td>
                                <td className="py-3 px-4"><span className="text-purple-400">Valibot</span></td>
                                <td className="py-3 px-4 text-slate-400">Zod's cooler, lighter cousin. Same vibes, 90% less bundle.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Styling</td>
                                <td className="py-3 px-4"><span className="text-cyan-400">Tailwind CSS v4</span></td>
                                <td className="py-3 px-4 text-slate-400">CSS-in-classes that actually ships. No config, just vibes.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Linting</td>
                                <td className="py-3 px-4"><span className="text-orange-400">Biome</span></td>
                                <td className="py-3 px-4 text-slate-400">ESLint + Prettier took too long to configure. Biome just works.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">State (Client)</td>
                                <td className="py-3 px-4"><span className="text-yellow-400">Zustand</span></td>
                                <td className="py-3 px-4 text-slate-400">Redux gave us nightmares. Zustand gave us 3 lines of code.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">State (Server)</td>
                                <td className="py-3 px-4"><span className="text-indigo-400">TanStack Query</span></td>
                                <td className="py-3 px-4 text-slate-400">Caching, refetching, loading states—all the boring stuff, solved.</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-white">Testing</td>
                                <td className="py-3 px-4"><span className="text-emerald-400">Vitest</span></td>
                                <td className="py-3 px-4 text-slate-400">Jest, but actually fast. Native ESM, TypeScript, Vite-powered.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <section className="space-y-4">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-1">
                            CRA is deprecated and slow. Vite is the new standard—instant HMR,
                            modern tooling, and no ejection needed.
                        </p>
                    </div>
                </div>
            </section>
