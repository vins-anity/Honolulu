import { Rocket, Server, Cloud, Box } from "lucide-react";
        ...
        <div className="space-y-12">
            <div>
                ...
                <p className="text-lg text-slate-400 leading-relaxed">
                    Honolulu is designed to be deployed anywhere that supports Node.js or Docker.
                    Here are the recommended paths for getting your app into production.
                </p>
            </div>
            ...
            <section className="space-y-6">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-4">
                    ...
                    <p className="text-slate-400">
                        The easiest way to deploy the React frontend.
                    </p>
                    <ol className="list-decimal list-inside space-y-3 text-slate-300 ml-4">
                        <li>Install Vercel CLI: <code className="bg-slate-800 px-1.5 py-0.5 rounded text-white text-sm">npm i -g vercel</code></li>
                        <li>Run deploy command:
            ...
            <section className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-4">
                        ...
                        <p className="text-slate-400">
                            Perfect for full-stack monorepos. Zero config.
                        </p>
                        <ul className="space-y-2 text-slate-300 list-disc list-inside">
                            <li>Connect your GitHub repo</li>
                            <li>Railway detects <code>bun.lockb</code></li>
                            <li>Add a PostgreSQL service</li>
                            <li>Set <code>DATABASE_URL</code> in variables</li>
                            <li>Deploy! 🚂</li>
                        </ul>
                    </div>
            ...
            <section className="space-y-6">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-4">
                    <p className="text-slate-400 mb-4">
                        Since we use Bun, your Docker images are tiny and fast.
                        Create a <code>Dockerfile</code> in <code>apps/api</code>:
                    </p>
...
CMD ["bun", "run", "start"]`}
            ...
            <section className="space-y-6">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-3 text-slate-300 ml-4">
                        <li>Install Wrangler: <code className="bg-slate-800 px-1.5 py-0.5 rounded text-white text-sm">npm i -g wrangler</code></li>
                        <li>Login to Cloudflare: <code className="bg-slate-800 px-1.5 py-0.5 rounded text-white text-sm">wrangler login</code></li>
                        <li>Deploy:
