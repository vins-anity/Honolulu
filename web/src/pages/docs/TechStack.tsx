import { Cpu, Terminal, Shield, Database, Palette, Zap } from "lucide-react";
        ...
        <div className="space-y-12">
            <div>
                ...
                <p className="text-lg text-slate-400 leading-relaxed">
                    Honolulu is opinionated. We've chosen the best-in-class tools for 2025 development
                    so you don't have to waste time researching.
                </p>
            </div>
