				...
				<div className="max-w-7xl w-full mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
					<div className="text-center lg:text-left space-y-8">
						...
						<p className="text-lg sm:text-xl text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
							Leave the config chaos on the mainland. Surf past the boilerplate and ship your vision
							before the sun sets.
						</p>
						...
						<div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
							...
							<button
								type="button"
								className="flex items-center gap-3 px-5 py-4 rounded-xl bg-slate-800/50 border border-slate-700/50 backdrop-blur-sm cursor-pointer hover:bg-slate-800/80 transition-colors group text-left w-full sm:w-auto"
								onClick={() => {
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
							No hidden fees, no complex setup. Just check in and start building. We've prepared the
							ultimate suite for your next big idea.
						</p>
					</div>
						...
						<div className="md:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700/50 hover:border-teal-500/50 transition-all group relative overflow-hidden">
							...
							<div className="relative z-10">
								...
								<p className="text-slate-400 text-lg leading-relaxed max-w-md">
									Powered by Bun Installs packages 3x faster than Node.js and starts instantly. Feel
									the wind in your hair as you deploy.
								</p>
							</div>
						</div>
						...
						<div className="md:col-span-2 p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700/50 hover:border-purple-500/50 transition-all group relative overflow-hidden">
							...
							<div className="relative z-10">
								...
								<h3 className="text-2xl font-bold text-white mb-3">
									5-Star Room Service (Drizzle)
								</h3>
								<p className="text-slate-400 text-lg leading-relaxed max-w-lg">
									Type-safe SQL schema delivered straight to your database. Migrations included.
									Verified compatibility with Supabase & Postgres.
								</p>
							</div>
						</div>
			...
			<footer className="py-12 text-center text-slate-500 text-sm border-t border-slate-800/30 bg-[#0f172a]">
				<div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
					...
					<div className="flex gap-6">
						...
						<Link to="/docs/introduction" className="hover:text-white transition-colors">
							Documentation
						</Link>
					</div>
				</div>
